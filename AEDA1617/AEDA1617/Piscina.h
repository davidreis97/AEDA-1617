...
public:
	...
	* @return true se m for uma modalidade, false se m não for uma modalidade
 	*/
	...
	* @return true se for adiciona com sucesso, false se já existir uma modalidade na lista com o mesmo nome
	*/
	...
	* @return true se foi removida com sucesso, false se não existir uma modalidade com o nome dado
	*/
